...
async function ExtractAndGetBinPath(compressedFilePath, platform) {
    ...
    const aria2BinPath = path.join(path.dirname(compressedFilePath), compressedFileFolderName, compressedFileFolderName, aria2BinName);
    return aria2BinPath;
}
export default async function downloadAria2Exe(dir = './') {
